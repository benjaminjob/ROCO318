...
"""autogenerated by genpy from op3_tuning_module_msgs/GetPresentJointOffsetDataRequest.msg. Do not edit."""
import codecs
import sys
...
class GetPresentJointOffsetDataRequest(genpy.Message):
  ...
  _type = "op3_tuning_module_msgs/GetPresentJointOffsetDataRequest"
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from op3_tuning_module_msgs/GetPresentJointOffsetDataResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GetPresentJointOffsetDataResponse(genpy.Message):
  ...
  _type = "op3_tuning_module_msgs/GetPresentJointOffsetDataResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
int32   d_gain"""
  ...
  _slot_types = ['op3_tuning_module_msgs/JointOffsetPositionData[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = op3_tuning_module_msgs.msg.JointOffsetPositionData()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
...
class GetPresentJointOffsetData(object):
  _type          = 'op3_tuning_module_msgs/GetPresentJointOffsetData'
  _md5sum = 'fe3cab7abbd49468a5d502064853404e'
