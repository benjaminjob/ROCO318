...
if("TRUE" STREQUAL "TRUE")
  set(op3_head_control_module_SOURCE_PREFIX /home/benjamin/ROCO318/catkin_ws/src/ROBOTIS-OP3/op3_head_control_module)
  set(op3_head_control_module_DEVEL_PREFIX /home/benjamin/ROCO318/catkin_ws/devel)
  ...
  set(op3_head_control_module_INSTALL_PREFIX /home/benjamin/ROCO318/catkin_ws/install)
...
if(NOT "/home/benjamin/ROCO318/catkin_ws/src/ROBOTIS-OP3/op3_head_control_module/include;/usr/include;/usr/include/eigen3 " STREQUAL " ")
  set(op3_head_control_module_INCLUDE_DIRS "")
  set(_include_dirs "/home/benjamin/ROCO318/catkin_ws/src/ROBOTIS-OP3/op3_head_control_module/include;/usr/include;/usr/include/eigen3")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'op3_head_control_module' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/benjamin/ROCO318/catkin_ws/src/ROBOTIS-OP3/op3_head_control_module/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT op3_head_control_module_NUM_DUMMY_TARGETS)
      set(op3_head_control_module_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::op3_head_control_module::wrapped-linker-option${op3_head_control_module_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR op3_head_control_module_NUM_DUMMY_TARGETS "${op3_head_control_module_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::op3_head_control_module::wrapped-linker-option${op3_head_control_module_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND op3_head_control_module_LIBRARIES "${interface_target_name}")
