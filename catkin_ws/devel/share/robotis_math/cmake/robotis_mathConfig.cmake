...
if("TRUE" STREQUAL "TRUE")
  set(robotis_math_SOURCE_PREFIX /home/benjamin/ROCO318/catkin_ws/src/ROBOTIS-Math/robotis_math)
  set(robotis_math_DEVEL_PREFIX /home/benjamin/ROCO318/catkin_ws/devel)
  ...
  set(robotis_math_INSTALL_PREFIX /home/benjamin/ROCO318/catkin_ws/install)
...
if(NOT "/home/benjamin/ROCO318/catkin_ws/src/ROBOTIS-Math/robotis_math/include;/usr/include/eigen3 " STREQUAL " ")
  set(robotis_math_INCLUDE_DIRS "")
  set(_include_dirs "/home/benjamin/ROCO318/catkin_ws/src/ROBOTIS-Math/robotis_math/include;/usr/include/eigen3")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robotis_math' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/benjamin/ROCO318/catkin_ws/src/ROBOTIS-Math/robotis_math/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT robotis_math_NUM_DUMMY_TARGETS)
      set(robotis_math_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::robotis_math::wrapped-linker-option${robotis_math_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR robotis_math_NUM_DUMMY_TARGETS "${robotis_math_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::robotis_math::wrapped-linker-option${robotis_math_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND robotis_math_LIBRARIES "${interface_target_name}")
