...
if("TRUE" STREQUAL "TRUE")
  set(open_cr_module_SOURCE_PREFIX /home/benjamin/ROCO318/catkin_ws/src/ROBOTIS-OP3/open_cr_module)
  set(open_cr_module_DEVEL_PREFIX /home/benjamin/ROCO318/catkin_ws/devel)
  ...
  set(open_cr_module_INSTALL_PREFIX /home/benjamin/ROCO318/catkin_ws/install)
...
if(NOT "/home/benjamin/ROCO318/catkin_ws/src/ROBOTIS-OP3/open_cr_module/include;/usr/include;/usr/include/eigen3 " STREQUAL " ")
  set(open_cr_module_INCLUDE_DIRS "")
  set(_include_dirs "/home/benjamin/ROCO318/catkin_ws/src/ROBOTIS-OP3/open_cr_module/include;/usr/include;/usr/include/eigen3")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'open_cr_module' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/benjamin/ROCO318/catkin_ws/src/ROBOTIS-OP3/open_cr_module/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT open_cr_module_NUM_DUMMY_TARGETS)
      set(open_cr_module_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::open_cr_module::wrapped-linker-option${open_cr_module_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR open_cr_module_NUM_DUMMY_TARGETS "${open_cr_module_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::open_cr_module::wrapped-linker-option${open_cr_module_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND open_cr_module_LIBRARIES "${interface_target_name}")
