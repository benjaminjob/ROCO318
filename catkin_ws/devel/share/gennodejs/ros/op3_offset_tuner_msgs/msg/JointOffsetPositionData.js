...
class JointOffsetPositionData {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('present_value')) {
        this.present_value = initObj.present_value
      }
      else {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [present_value]
    bufferOffset = _serializer.float64(obj.present_value, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new JointOffsetPositionData(null);
    ...
    // Deserialize message field [present_value]
    data.present_value = _deserializer.float64(buffer, bufferOffset);
  ...
  static datatype() {
    ...
    return 'op3_offset_tuner_msgs/JointOffsetPositionData';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new JointOffsetPositionData(null);
    ...
    if (msg.present_value !== undefined) {
      resolved.present_value = msg.present_value;
    }
    else {
      resolved.present_value = 0.0
    }
...
module.exports = JointOffsetPositionData;
