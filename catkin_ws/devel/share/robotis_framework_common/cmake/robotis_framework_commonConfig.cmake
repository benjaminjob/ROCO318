...
if("TRUE" STREQUAL "TRUE")
  set(robotis_framework_common_SOURCE_PREFIX /home/benjamin/ROCO318/catkin_ws/src/ROBOTIS-Framework/robotis_framework_common)
  set(robotis_framework_common_DEVEL_PREFIX /home/benjamin/ROCO318/catkin_ws/devel)
  ...
  set(robotis_framework_common_INSTALL_PREFIX /home/benjamin/ROCO318/catkin_ws/install)
...
if(NOT "/home/benjamin/ROCO318/catkin_ws/src/ROBOTIS-Framework/robotis_framework_common/include " STREQUAL " ")
  set(robotis_framework_common_INCLUDE_DIRS "")
  set(_include_dirs "/home/benjamin/ROCO318/catkin_ws/src/ROBOTIS-Framework/robotis_framework_common/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robotis_framework_common' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/benjamin/ROCO318/catkin_ws/src/ROBOTIS-Framework/robotis_framework_common/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT robotis_framework_common_NUM_DUMMY_TARGETS)
      set(robotis_framework_common_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::robotis_framework_common::wrapped-linker-option${robotis_framework_common_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR robotis_framework_common_NUM_DUMMY_TARGETS "${robotis_framework_common_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::robotis_framework_common::wrapped-linker-option${robotis_framework_common_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND robotis_framework_common_LIBRARIES "${interface_target_name}")
