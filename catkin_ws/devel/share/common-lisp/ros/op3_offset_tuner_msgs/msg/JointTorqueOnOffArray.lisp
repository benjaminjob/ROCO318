...
(cl:defclass <JointTorqueOnOffArray> (roslisp-msg-protocol:ros-message)
  ((torque_enable_data
    ...
    :type (cl:vector op3_offset_tuner_msgs-msg:JointTorqueOnOff)
   :initform (cl:make-array 0 :element-type 'op3_offset_tuner_msgs-msg:JointTorqueOnOff :initial-element (cl:make-instance 'op3_offset_tuner_msgs-msg:JointTorqueOnOff))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <JointTorqueOnOffArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointTorqueOnOffArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name op3_offset_tuner_msgs-msg:<JointTorqueOnOffArray> is deprecated: use op3_offset_tuner_msgs-msg:JointTorqueOnOffArray instead.")))
...
(cl:defmethod torque_enable_data-val ((m <JointTorqueOnOffArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader op3_offset_tuner_msgs-msg:torque_enable_data-val is deprecated.  Use op3_offset_tuner_msgs-msg:torque_enable_data instead.")
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <JointTorqueOnOffArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'torque_enable_data)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'op3_offset_tuner_msgs-msg:JointTorqueOnOff))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<JointTorqueOnOffArray>)))
  ...
  "op3_offset_tuner_msgs/JointTorqueOnOffArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'JointTorqueOnOffArray)))
  "Returns string type for a message object of type 'JointTorqueOnOffArray"
  "op3_offset_tuner_msgs/JointTorqueOnOffArray")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<JointTorqueOnOffArray>)))
  ...
  (cl:format cl:nil "JointTorqueOnOff[] torque_enable_data~%================================================================================~%MSG: op3_offset_tuner_msgs/JointTorqueOnOff~%string  joint_name~%bool    torque_enable~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'JointTorqueOnOffArray)))
  "Returns full string definition for message of type 'JointTorqueOnOffArray"
  (cl:format cl:nil "JointTorqueOnOff[] torque_enable_data~%================================================================================~%MSG: op3_offset_tuner_msgs/JointTorqueOnOff~%string  joint_name~%bool    torque_enable~%~%"))
