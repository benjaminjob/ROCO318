...
(cl:defmethod cl:initialize-instance :after ((m <JointOffsetPositionData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointOffsetPositionData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name op3_offset_tuner_msgs-msg:<JointOffsetPositionData> is deprecated: use op3_offset_tuner_msgs-msg:JointOffsetPositionData instead.")))
...
(cl:defmethod present_value-val ((m <JointOffsetPositionData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader op3_offset_tuner_msgs-msg:present_value-val is deprecated.  Use op3_offset_tuner_msgs-msg:present_value instead.")
  (present_value m))
