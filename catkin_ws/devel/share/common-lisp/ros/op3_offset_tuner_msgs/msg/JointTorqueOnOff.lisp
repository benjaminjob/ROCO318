...
(cl:defmethod cl:initialize-instance :after ((m <JointTorqueOnOff>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointTorqueOnOff)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name op3_offset_tuner_msgs-msg:<JointTorqueOnOff> is deprecated: use op3_offset_tuner_msgs-msg:JointTorqueOnOff instead.")))
...
(cl:defmethod torque_enable-val ((m <JointTorqueOnOff>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader op3_offset_tuner_msgs-msg:torque_enable-val is deprecated.  Use op3_offset_tuner_msgs-msg:torque_enable instead.")
  (torque_enable m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<JointTorqueOnOff>)))
  ...
  "op3_offset_tuner_msgs/JointTorqueOnOff")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'JointTorqueOnOff)))
  "Returns string type for a message object of type 'JointTorqueOnOff"
  "op3_offset_tuner_msgs/JointTorqueOnOff")
