...
(cl:in-package op3_offset_tuner_msgs-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <GetPresentJointOffsetData-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetPresentJointOffsetData-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name op3_offset_tuner_msgs-srv:<GetPresentJointOffsetData-request> is deprecated: use op3_offset_tuner_msgs-srv:GetPresentJointOffsetData-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetPresentJointOffsetData-request>)))
  ...
  "op3_offset_tuner_msgs/GetPresentJointOffsetDataRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetPresentJointOffsetData-request)))
  "Returns string type for a service object of type 'GetPresentJointOffsetData-request"
  "op3_offset_tuner_msgs/GetPresentJointOffsetDataRequest")
...
(cl:defclass <GetPresentJointOffsetData-response> (roslisp-msg-protocol:ros-message)
  ((present_data_array
    ...
    :type (cl:vector op3_offset_tuner_msgs-msg:JointOffsetPositionData)
   :initform (cl:make-array 0 :element-type 'op3_offset_tuner_msgs-msg:JointOffsetPositionData :initial-element (cl:make-instance 'op3_offset_tuner_msgs-msg:JointOffsetPositionData))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <GetPresentJointOffsetData-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetPresentJointOffsetData-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name op3_offset_tuner_msgs-srv:<GetPresentJointOffsetData-response> is deprecated: use op3_offset_tuner_msgs-srv:GetPresentJointOffsetData-response instead.")))
...
(cl:defmethod present_data_array-val ((m <GetPresentJointOffsetData-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader op3_offset_tuner_msgs-srv:present_data_array-val is deprecated.  Use op3_offset_tuner_msgs-srv:present_data_array instead.")
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <GetPresentJointOffsetData-response>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'present_data_array)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'op3_offset_tuner_msgs-msg:JointOffsetPositionData))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetPresentJointOffsetData-response>)))
  ...
  "op3_offset_tuner_msgs/GetPresentJointOffsetDataResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetPresentJointOffsetData-response)))
  "Returns string type for a service object of type 'GetPresentJointOffsetData-response"
  "op3_offset_tuner_msgs/GetPresentJointOffsetDataResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GetPresentJointOffsetData-response>)))
  ...
  (cl:format cl:nil "JointOffsetPositionData[] present_data_array~%~%================================================================================~%MSG: op3_offset_tuner_msgs/JointOffsetPositionData~%string  joint_name~%float64 goal_value~%float64 offset_value~%float64 present_value~%int32   p_gain~%int32   i_gain~%int32   d_gain~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GetPresentJointOffsetData-response)))
  "Returns full string definition for message of type 'GetPresentJointOffsetData-response"
  (cl:format cl:nil "JointOffsetPositionData[] present_data_array~%~%================================================================================~%MSG: op3_offset_tuner_msgs/JointOffsetPositionData~%string  joint_name~%float64 goal_value~%float64 offset_value~%float64 present_value~%int32   p_gain~%int32   i_gain~%int32   d_gain~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetPresentJointOffsetData)))
  ...
  "op3_offset_tuner_msgs/GetPresentJointOffsetData")