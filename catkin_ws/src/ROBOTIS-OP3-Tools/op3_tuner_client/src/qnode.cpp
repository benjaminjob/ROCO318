...
bool QNode::init()
{
  ros::init(init_argc_, init_argv_, "op3_tuner_client");

  ros::start();  // explicitly needed since our nodehandle is going out of scope.
  ros::NodeHandle ros_node;

  // Add your ros communications here
  joint_offset_data_pub_ = ros_node.advertise<op3_tuning_module_msgs::JointOffsetData>(
...
void QNode::sendTorqueEnableMsg(op3_tuning_module_msgs::JointTorqueOnOffArray msg)
{
...
void QNode::sendJointOffsetDataMsg(op3_tuning_module_msgs::JointOffsetData msg)
{
...
void QNode::sendJointGainDataMsg(op3_tuning_module_msgs::JointOffsetData msg)
{
...
void QNode::getPresentJointOffsetData(bool recalculate_offset)
{
  ...
  op3_tuning_module_msgs::GetPresentJointOffsetData _get_present_joint_offset_data;
